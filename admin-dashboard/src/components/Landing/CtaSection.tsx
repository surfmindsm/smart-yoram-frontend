      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-primary-100 text-lg">전국 교회 도입</div>
            <div className="text-primary-200 text-sm mt-1">지속적인 성장</div>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-bold text-white mb-3">50,000+</div>
            <div className="text-primary-100 text-lg">교인 사용자</div>
            <div className="text-primary-200 text-sm mt-1">활발한 참여</div>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-bold text-white mb-3">99.9%</div>
            <div className="text-primary-100 text-lg">서비스 안정성</div>
            <div className="text-primary-200 text-sm mt-1">안전한 운영</div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-primary-100">
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-primary-200">교회 규모나 교인 수 제한 없음</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
              <div className="text-left">
                ...
                <p className="text-sm text-primary-200">도입부터 운영까지 1:1 관리</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
              <div className="text-left">
                ...
                <p className="text-sm text-primary-200">기존 교적부 100% 무손실 이전</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-400 rounded-full mt-2 flex-shrink-0"></div>
              <div className="text-left">
                ...
                <p className="text-sm text-primary-200">언제든지 도움이 필요할 때</p>
              </div>
            </div>
          </div>
        </div>
