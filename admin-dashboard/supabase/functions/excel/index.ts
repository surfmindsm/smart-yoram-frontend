  ...
  try {
    ...
    if (pathParts.includes('members') && pathParts.includes('template') && req.method === 'GET') {
      ...
      const templateContent = [
        ...
        '홍길동,Hong Gil Dong,hong@example.com,010-1234-5678,남,1990-01-15,양력,장로,청년부,청년1부,2020-01-01,서울중앙교회,기혼,김영희,2015-05-20,06234,서울시 강남구 테헤란로 123,서울시,강남구,역삼동,정교인,2010-06-01,1구역,청년,A급,2024-12-01,사무직,소프트웨어 개발,팀장,회사원,삼성전자,02-2255-0114,2018-01-01,은혜교회,장로 추천,,새벽기도 참석,특기사항1,,,,,,,,,,,,건강상 주의사항 없음',
