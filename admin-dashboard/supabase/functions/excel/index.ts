...
serve(async (req) => {
  ...
  try {
    ...
    if (pathParts.includes('members') && pathParts.includes('template') && req.method === 'GET') {
      ...
      // 시트 1: 교인 데이터 입력용
      const memberData = [
        ['이름*', '영문명', '이메일', '전화번호*', '성별', '생년월일', '생년월일구분', '직분', '조직', '부서', '임명일', '안수교회', '결혼상태', '배우자이름', '결혼일', '우편번호', '주소', '지역1', '지역2', '지역3', '교인구분', '입교일', '소구역', '나이그룹', '신급', '마지막연락일', '직업분류', '구체적업무', '직책직위', '직업명', '직장명', '직장전화번호', '사역시작일', '이웃교회', '직분결정', '인도자ID', '일상활동', '자유필드1', '자유필드2', '자유필드3', '자유필드4', '자유필드5', '자유필드6', '자유필드7', '자유필드8', '자유필드9', '자유필드10', '자유필드11', '자유필드12', '특별사항'],
        ['홍길동', 'Hong Gil Dong', 'hong@example.com', '010-1234-5678', '남', '1990-01-15', '양력', '시무장로', '청년부', '청년1부', '2020-01-01', '서울중앙교회', '기혼', '김영희', '2015-05-20', '06234', '서울시 강남구 테헤란로 123', '서울시', '강남구', '역삼동', '정교인', '2010-06-01', '1구역', '청년', 'A급', '2024-12-01', '사무직', '소프트웨어 개발', '팀장', '회사원', '삼성전자', '02-2255-0114', '2018-01-01', '은혜교회', '장로 추천', '', '새벽기도 참석', '특기사항1', '', '', '', '', '', '', '', '', '', '', '', '건강상 주의사항 없음'],
        ['김영희', 'Kim Young Hee', 'kim@example.com', '010-9876-5432', '여', '1985-05-20', '음력', '집사', '여전도회', '여전도1부', '2019-03-15', '부산온누리교회', '기혼', '홍길동', '2015-05-20', '06235', '서울시 서초구 서초대로 456', '서울시', '서초구', '서초동', '정교인', '2008-03-10', '2구역', '성인', 'B급', '2024-11-28', '교육직', '초등학교 교사', '교사', '교사', '서울초등학교', '02-3456-7890', '2017-06-01', '사랑교회', '집사 임명', '', '구역모임 리더', '', '', '', '', '', '', '', '', '', '', '', '', '알레르기: 새우'],
        ['이민수', 'Lee Min Soo', 'lee@example.com', '010-5555-6666', '남', '2010-03-10', '양력', '초등부', '교회학교', '초등3부', '', '', '미혼', '', '', '06236', '서울시 송파구 올림픽로 789', '서울시', '송파구', '잠실동', '', '2018-05-01', '3구역', '아동', '', '2024-12-05', '', '', '학생', '학생', '서울초등학교', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
        ['박서영', 'Park Seo Young', 'park@example.com', '010-7777-8888', '여', '2005-07-15', '양력', '고등부', '교회학교', '고등부', '', '', '미혼', '', '', '06237', '서울시 강서구 마곡중앙로 100', '서울시', '강서구', '마곡동', '', '2015-03-01', '4구역', '청소년', '', '2024-12-03', '', '', '학생', '학생', '서울고등학교', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']
      ];
